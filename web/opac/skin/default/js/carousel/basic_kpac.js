...
function mycarousel_getItemHTML(item)
{
    ...
    return '<a target="_top" href="'+total+'eg/kpac/record/' + item.bibid + '"><img src="'+total+'opac/extras/ac/jacket/medium/r/' + item.bibid + '" width="96" onerror="this.src=\'https://catalog.tadl.org/opac/images/blank.png\'" height="150" alt="' + item.title + '" /><br />' + item.title + '</a>';
};
